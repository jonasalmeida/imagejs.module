...
(function(){
	...
	var menu={
		'Help':function(){imagejs.msg('See <a href="http://www.youtube.com/watch?v=NCPNgRxWWDQ" target="blank">SCREENCAST</a> of capture a) segmented in positive ki67 nuclei and b) segmented out all nuclei.<br> See also <a href=""> WIKI</a> for more information and calibration data. [<a href="https://code.google.com/p/imagejs/source/browse/ki67.js?repo=module" target="blank">Source code</a>, <a href="https://code.google.com/p/imagejs/source/list?repo=module" target="blank">Change log</a>].')},
